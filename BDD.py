...
def main() -> None:
    ...
    while (decision != 9):
        ...
        if (decision == 1):
            ...
            run_all_test_cases(RR_BDD, EVEN_BDD, PRIME_BDD, PRIME_BDD)
        elif (decision == 9):
            break
...
def make_RR_edge(x_node : int, y_node : int) -> Expression:
...
def make_EVEN_edge(num : int) -> Expression:
...
def make_PRIME_edge(num : int) -> Expression:
